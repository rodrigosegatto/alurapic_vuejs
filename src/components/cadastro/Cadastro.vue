  ...
  <div>
    ...
    <form @submit.prevent="grava()">
      <div class="controle">
        ...
        <input id="titulo" autocomplete="off" name="titulo"
          v-model="foto.titulo" v-validate data-vv-rules="required|min:3|max:30" />
        <span class="erro" v-show="errors.has('titulo')">{{ errors.first('titulo') }}</span>
      </div>

      <div class="controle">
        <label for="url">URL</label>
        <input id="url" autocomplete="off" name="url"
      ...
      <div class="controle">
        ...
        <textarea id="descricao" autocomplete="off"
            v-model.lazy="foto.descricao"></textarea>
      </div>
